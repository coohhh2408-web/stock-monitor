...
export const STOCK_CATALOG: StockCatalogEntry[] = [
  ...
  { name: '格力电器', code: '000651', market: 'a-share', basePrice: 42.80, aliases: ['格力'] },
  { name: '美的集团', code: '000333', market: 'a-share', basePrice: 64.10, aliases: ['美的'] },
  { name: '海尔智家', code: '600690', market: 'a-share', basePrice: 25.40, aliases: ['海尔'] },
